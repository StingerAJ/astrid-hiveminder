 ...
 *
 */
public class HiveBackgroundService extends Service {
    ...
    private void startSynchronization(Context context) {
        ...
        if(HiveUtilities.INSTANCE.isOngoing())
            return;

        new HiveSyncProvider().synchronize(context);
    }
    ...
    public static void scheduleService() {
        ...
        int syncFrequencySeconds = HiveUtilities.INSTANCE.getSyncAutoSyncFrequency();
    ...
    private static Intent createAlarmIntent(Context context) {
        Intent intent = new Intent(context, HiveBackgroundService.class);
    ...
    private static long computeNextSyncOffset(long interval) {
        ...
        long lastSyncDate = HiveUtilities.INSTANCE.getLastSyncDate();
