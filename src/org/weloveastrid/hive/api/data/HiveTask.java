    ...
    extends HiveData
{
    ...
    private static final String TAG = "hive-task";
  ...
  public static String convertPriority(Priority priority)
  {
    ...
    default:
      Log.e(TAG, "Unrecognized Hiveminder task priority: '" + priority + "'");
      return new String(new char[] { 'n' });
    }
  }

  public HiveTask(String id, Date due, boolean hasDueTime, Date added, Date completed, Date deleted, Priority priority, int postponed, String estimate)
  {
    this.id = id;
    this.due = due;
  ...
  public HiveTask(Element elt)
  {
    ...
    if (priorityStr.length() > 0)
    {
      ...
      case '1':
        ...
        break;
      default:
        System.err.println("Unrecognized Hiveminder task priority: '" + priorityStr + "'");
        priority = Priority.Medium;
      }
    }
    else
