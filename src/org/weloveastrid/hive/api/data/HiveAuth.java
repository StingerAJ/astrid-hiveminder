...
public class HiveAuth extends HiveData {
  ...
  private final HiveUser user;

  public HiveAuth(String token, Perms perms, HiveUser user) {
    this.token = token;
    this.perms = perms;
    this.user = user;
  }

  public HiveAuth(Element elt) {
    ...
    this.user = new HiveUser(child(elt, "user"));
  }
