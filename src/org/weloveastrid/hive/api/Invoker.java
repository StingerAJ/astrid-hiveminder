...
/**
 * Handles the details of invoking a method on the Hiveminder REST API.
 *
...
public class Invoker {
    ...
    private static final String TAG = "hive-invoker"; //$NON-NLS-1$
  ...
  public Element invoke(boolean repeat, Param... params)
        ...
        try {
            ...
            if (!wrapperElt.getNodeName().equals("rsp")) {
                throw new ServiceInternalException(
                        "unexpected response returned by Hiveminder service: "
