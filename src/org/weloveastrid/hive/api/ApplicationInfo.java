...
/**
 * Encapsulates information about an application that is a client of RememberTheMilk. Includes information required by Hiveminder to connect: the API key and
 * the shared secret.
 * 
