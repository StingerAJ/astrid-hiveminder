 ...
 *
 */
public class HiveLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hive_login_activity);
        setTitle(R.string.hive_MPr_header);
                    ...
                    public void run() {
            			...
            			if(result == null) {
        			    	...
        			    	handler.post(new Runnable() {
                                public void run() {
                                    DialogUtilities.okDialog(HiveLoginActivity.this,
                                            result, null);
                                    webView.loadUrl(urlParam);
                                }
        			    	});
