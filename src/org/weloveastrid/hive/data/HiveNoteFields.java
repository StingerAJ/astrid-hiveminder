 ...
 *
 */
public class HiveNoteFields {

    /** metadata key */
    public static final String METADATA_KEY = "hive-note"; //$NON-NLS-1$
    ...
    public static Metadata create(HiveTaskNote note) {
    ...
    public static String toNoteField(HiveTaskNote note) {
